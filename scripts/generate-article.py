...
# -*- coding: utf-8 -*-
"""
Génération automatique d'un article de blog — Les P'tits Soleils.
...
def slugify(title: str, max_words: int = 7) -> str:
    ...
    # (« …-tarbes-arsenal-comment ») quand la troncature tombe au mauvais endroit.
...
def mock_content(cfg: dict, topic: dict) -> dict:
    ...
    targets = cfg["internal_link_targets"]
    filler = ("Sur l'agglomération tarbaise, la question se pose différemment d'une famille à "
              "l'autre selon les horaires de travail, le trajet quotidien et l'âge de "
              "l'enfant. Entre Tarbes, Séméac et Aureilhan les distances "
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Génère un article de blog Les P'tits Soleils.")
